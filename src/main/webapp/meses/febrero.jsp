...
<html>
<head>
    <title>Tareas mes de febrero</title>
    <style>
...
<table>
    ...
    <% if (request.getAttribute("tareasFebrero") != null) {
        List<Tarea> tareas = (List<Tarea>) request.getAttribute("tareasFebrero");
